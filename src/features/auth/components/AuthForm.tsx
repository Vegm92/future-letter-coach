...
const AuthForm = ({ onBack }: AuthFormProps) => {
  ...
  const { signUp, signIn, signInWithGoogle, isAuthenticating } = useAuth();
      ...
      <div className="w-full max-w-md">
        <div className="mb-6">
          ...
          <div className="text-center">
            ...
            <p className="text-muted-foreground">Join the goal achievement revolution</p>
          </div>
        </div>
            ...
            <Tabs defaultValue="signin" className="space-y-4">
              ...
              <TabsContent value="signin" className="space-y-4">
                <form onSubmit={handleSignIn} className="space-y-4">
                  ...
                  <Button type="submit" variant="hero" className="w-full" disabled={isAuthenticating}>
